@extends('layouts.app')
@section('title', env('APP_NAME').' - '.trans('messages.create').' '.trans('messages.studySubject'))

@section('content')
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-fw fa-book"></i> @lang('messages.create') @lang('messages.studySubject')
        </h1>
    </div>
    <!-- End Page Heading -->

    <form action="{{ route('studySubject.store') }}" method="post" autocomplete="off" id="form">
        @csrf
