                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="teacher_id" name="teacher_id" class="form-control" required style="width: 100%;">
                                ...
                                @foreach($teachers as $teacher)
                                    <option value="{{ $teacher->id }}" @if(old('teacher_id') == $teacher->id) selected @endif>{{ $teacher->full_name }} - {{ $teacher->code }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select id="city_id" name="city_id" class="form-control" disabled style="width: 100%;">
