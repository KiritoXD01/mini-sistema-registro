...
<div class="container">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">@lang('messages.welcome') @lang('messages.teacher')</h1>
                                </div>
                                <form action="{{ route('teacher.login') }}" class="user needs-validation" autocomplete="off" method="post" id="form">
                                    @csrf
                                    @if(session('error'))
    ...
    <div class="modal fade" id="modalForgotPassword">
        <form action="{{ route('teacher.password.email') }}" method="POST" autocomplete="off">
            @csrf
