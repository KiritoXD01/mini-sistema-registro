@extends('layouts.app')
@section('title', env('APP_NAME').' - '.trans('messages.create').' '.trans('messages.courseType'))

@section('content')
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-fw fa-university"></i> @lang('messages.create') @lang('messages.courseType')
        </h1>
    </div>
    <!-- End Page Heading -->

    <form action="{{ route('courseType.store') }}" method="post" autocomplete="off" id="form">
        @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <button type="submit" class="btn btn-primary float-right">
                            <i class="fa fa-fw fa-save"></i> @lang('messages.save') @lang('messages.courseType')
                        </button>
                    </div>
                </div>
            </div>
